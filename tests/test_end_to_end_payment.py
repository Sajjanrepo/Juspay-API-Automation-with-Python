import pytest
from tests.test_create_customer import TestCreateCustomer
from tests.test_create_order import TestCreateOrder
from tests.test_Get_order_status_before_payment import TestBeforePaymentStatus
from tests.test_payment import TestPayment
from tests.test_Get_order_status_after_payment import TestAfterPaymentStatus
